...
$id = $_GET['id'];
$detailed = query("SELECT * FROM makeup WHERE id_makeup = $id");
	...
	if( $jumlah_pesan > $stok ){
		...
		document.location.href = 'detail-makeup.php'; </script>";
		return false;
	}
...
<div class="w3-top">
  <div class="w3-white w3-xlarge" style="max-width:1200px;margin:auto">
    ...
    <div class="w3-center w3-padding-16">
		...
		<!-- One -->
		<?php foreach ($detailed as $makeup) : ?>
			<section id="one" class="wrapper style1" style="background-color: #FFF">
				<div class="inner">
					<article class="feature left">
						<span class="image"><img src="img/makeup/<?php echo $makeup['nama_makeup'] ?>.jpg" alt="" /></span>
						<div class="content">
							<h2><?php echo $makeup['nama_makeup']; ?></h2>
							<table>
							<tr>
								<td>Harga :</td>
								<td><?php echo $makeup['harga']; ?></td>
							</tr>
							<tr>
								<td>Warna :</td>
								<td><?php echo $makeup['guna']; ?></td>
							</tr>>
							<tr>
								<td>Stok :</td>
								<td><?php echo $makeup['stok']; ?></td>
							</tr>
							</table>
							<ul class="actions">
								<li>
      ...
      <div class="modal-content">
        ...
        <?php foreach ($detailed as $transaksi ) : ?>
          <form method="POST" action="">
          	<input type="hidden" name="nama_produk" value="<?php echo $transaksi['nama_makeup'] ?>">
          	...
          	Nama Produk<br><p> <?php echo $transaksi["nama_makeup"]; ?> </p>
          	...
          	No Rekening <br>BCA - 023 234311398932 <br> BRI - 2739449719374
          	<br><br>Total Harga/Satuan<br><p>Rp. <?php echo $transaksi['harga']; ?></p>
