...
$jmlDataPerHalaman = 8;
  $dataSiswa = query("SELECT * FROM kids ORDER BY nama_kids");
...
$siswa = query("SELECT * FROM kids ORDER BY nama_kids LIMIT 
  ...
  <div class="w3-row-padding w3-padding-16 w3-center" id="food" >
    <?php foreach ($siswa as $row) : ?>
      <div class="w3-quarter" style="heigth: 500px">
        <a style="text-decoration: none" href="detail-kids.php?id=<?php echo $row['id_kids'] ; ?>">
        <img src="img/kids/<?php echo $row['nama_kids'] ?>.jpg" alt="Sandwich" style="width:100%">
        <h3 style="font-family: lato light"><?php echo $row["nama_kids"]; ?></h3>
