...
$id = $_GET['id'];
$detailed = query("SELECT * FROM cloth WHERE id_cloth = $id");
	...
	if( $jumlah_pesan > $stok ){
		...
		document.location.href = 'detail-clothes.php'; </script>";
		return false;
	}
...
<html>
	...
	<body>
		...
		<nav class="w3-sidebar w3-bar-block w3-card w3-top w3-xlarge w3-animate-left" style="display:none;z-index:2;width:22%;" id="mySidebar">
...
<div class="w3-top">
  <div class="w3-white w3-xlarge" style="max-width:1200px;margin:auto">
    ...
    <div class="w3-center w3-padding-16">
		...
		<!-- One -->
		<?php foreach ($detailed as $cloth) : ?>
			<section id="one" class="wrapper style1" style="background-color: #FFF">
				<div class="inner">
					<article class="feature left">
						<span class="image"><img src="img/clothes/<?php echo $cloth['nama_cloth'] ?>.jpg" alt="" /></span>
						<div class="content">
							<h2><?php echo $cloth['nama_cloth']; ?></h2>
							<table>
							<tr>
								<td>Harga :</td>
								<td><?php echo $cloth['harga']; ?></td>
							</tr>
							<tr>
								<td width="200px">Ukuran :</td>
								<td><?php echo $cloth['ukuran']; ?></td>
							</tr>
							<tr>
								<td>Warna :</td>
								<td><?php echo $cloth['warna']; ?></td>
							</tr>
							<tr>
								<td>Bahan :</td>
								<td style="text-align: justify;"><?php echo $cloth['bahan']; ?></td>
							</tr>
							<tr>
								<td>Stok :</td>
								<td><?php echo $cloth['stok']; ?></td>
							</tr>
							</table>
							<ul class="actions">
								<li>
      ...
      <div class="modal-content">
        ...
        <?php foreach ($detailed as $transaksi ) : ?>
          <form method="POST" action="">
          	<input type="hidden" name="nama_produk" value="<?php echo $transaksi['nama_cloth'] ?>">
          	...
          	Nama Produk<br><p> <?php echo $transaksi["nama_cloth"]; ?> </p>
