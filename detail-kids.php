...
$id = $_GET['id'];
$detailed = query("SELECT * FROM kids WHERE id_kids = $id");
	...
	if( $jumlah_pesan > $stok ){
		...
		document.location.href = 'detail-kids.php'; </script>";
		return false;
	}
...
<div class="w3-top">
  <div class="w3-white w3-xlarge" style="max-width:1200px;margin:auto">
    ...
    <div class="w3-right w3-padding-16">Kids</div>
    <div class="w3-center w3-padding-16">
		...
		<!-- One -->
		<?php foreach ($detailed as $kids) : ?>
			<section id="one" class="wrapper style1" style="background-color: #FFF">
				<div class="inner">
					<article class="feature left">
						<span class="image"><img src="img/kids/<?php echo $kids['nama_kids'] ?>.jpg" alt="" /></span>
						<div class="content">
							<h2><?php echo $kids['nama_kids']; ?></h2>
							<table>
							<tr>
								<td>Harga :</td>
								<td><?php echo $kids['harga']; ?></td>
							</tr>
							<tr>
								<td>Warna :</td>
								<td><?php echo $kids['deskripsi']; ?></td>
							</tr>
							<tr>
								<td>Stok :</td>
								<td><?php echo $kids['stok']; ?></td>
							</tr>
							</table>
							<ul class="actions">
								<li>
      ...
      <div class="modal-content">
        ...
        <?php foreach ($detailed as $transaksi ) : ?>
          <form method="POST" action="">
          	<input type="hidden" name="nama_produk" value="<?php echo $transaksi['nama_kids'] ?>">
          	...
          	Nama Produk<br><p> <?php echo $transaksi["nama_kids"]; ?> </p>
