...
$jmlDataPerHalaman = 8;
  $dataSiswa = query("SELECT * FROM makeup ORDER BY nama_makeup");
...
$siswa = query("SELECT * FROM makeup ORDER BY nama_makeup LIMIT 
  ...
  <div class="w3-row-padding w3-padding-16 w3-center" id="food" >
    <?php foreach ($siswa as $row) : ?>
      <div class="w3-quarter" style="heigth: 500px">
        <a style="text-decoration: none" href="detail-makeup.php?id=<?php echo $row['id_makeup'] ; ?>">
        <img src="img/makeup/<?php echo $row['nama_makeup'] ?>.jpg" alt="Sandwich" style="width:100%">
        <h3 style="font-family: lato light"><?php echo $row["nama_makeup"]; ?></h3>
