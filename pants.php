...
$jmlDataPerHalaman = 8;
  $dataSiswa = query("SELECT * FROM pant ORDER BY nama_pant");
...
$siswa = query("SELECT * FROM pant ORDER BY nama_pant LIMIT 
...
<div class="w3-top">
  <div class="w3-white w3-xlarge" style="max-width:1200px;margin:auto">
    ...
    <div class="w3-right w3-padding-16">Pants</div>
   ...
   <div class="w3-row-padding w3-padding-16 w3-center" id="food" >
    <?php foreach ($siswa as $row) : ?>
      <div class="w3-quarter" style="heigth: 500px">
        <a style="text-decoration: none" href="detail-pants.php?id=<?php echo $row['id_pant'] ; ?>">
        <img src="img/pants/<?php echo $row['nama_pant'] ?>.jpg" alt="Sandwich" style="width:100%">
        <h3 style="font-family: lato light"><?php echo $row["nama_pant"]; ?></h3>
